...
public class ClockPane extends Pane {
    ...
    public ClockPane(int hour, int minute, int second, boolean hourVisible, boolean minuteVisible, boolean secondVisible) {
        this.hour = hour;
        this.minute = minute;
        this.second = second;
        
        this.hourHandVisible = hourVisible;
        this.minuteHandVisible = minuteVisible;
        this.secondHandVisible = secondVisible;
        paintClock();
    }
  ...
  //Returns true if SecondHand is visble.
    ...
    protected void paintClock() {
        ...
        getChildren().clear();  
        getChildren().addAll(circle, t1, t2, t3, t4, dot);
